...
public interface NodeTransformer<E>{
	...
	/**
	 * Transforms a node array to an integer array, where the integer values represents the hash values
	 * 
	 * IN: [nodeA, nodeB, nodeC]
	 * OUT: [hash(nodeA), hash(nodeB), has(nodeC)]
	 * @author patrick
	 *
	 */
